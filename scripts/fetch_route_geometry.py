...
출력: assets/data/route_geometry.json
"""
...
INPUT_PATH = os.path.join(PROJECT_ROOT, "assets", "data", "route_data.json")
OUTPUT_PATH = os.path.join(PROJECT_ROOT, "assets", "data", "route_geometry.json")
