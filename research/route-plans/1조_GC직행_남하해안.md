...
> **총 이동거리**: 2,177km
> **S등급 방문**: 3곳 (케이프 바이런 등대, 룩앳미나우 헤드랜드, 뉴캐슬 메모리얼 워크)
...
### Day 5 — 5/28 (목): 포트맥쿼리 → 포트스테판스 (샌드보딩 + 넬슨베이 일몰)
...
| 17:30 | 저녁식사 | |
| 18:30 | 숙소 체크인, 여유로운 저녁 | 다음 날 일찍 출발 대비 충분한 휴식 |

- **출발지 → 도착지**: 포트맥쿼리 → 포트스테판스, 272km
- **운전:관광 비율**: 2.5h:6.5h (빡센 날)
- **핵심 장소**: 스톡턴 사막 샌드보딩, 토마리 헤드(A), 캥거루 인카운터스(B)
...
| 08:30~09:30 | **뉴캐슬 메모리얼 워크** (S, 87.0) | ANZAC Memorial Walk, 450m 해안 절벽 산책로. 아침 빛이 아름다움 |
| 09:40~10:15 | **보기 홀** (B, 75.5) | 해안 천연 해수풀, 사진/산책용 (5월 수영은 차가움) |
...
- **출발지 → 도착지**: 포트스테판스 → 시드니공항, 232km
- **운전:관광 비율**: 3h:2.5h (여유로운 반납일)
- **핵심 장소**: 뉴캐슬 메모리얼 워크(S), 보기 홀(B)
...
*작성: 2026-03-14 | 수정: 2026-03-15 (은하수 월령 검증, Day 2 커럼빈 옵션 추가, Day 3 바이런베이 체류 확대, 점수 조정) | 1조 3인 페르소나 (효율 전략가 김도현 / 감성 탐험가 이서아 / 현실주의 비평가 박지우) 합동 설계*
