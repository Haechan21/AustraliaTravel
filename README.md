...
## 시드니 Day 6~7 — 1조 클래식 하이라이트 확정

시드니 2일 코스 5개 안에 대한 [CRITIC_ROUTE](docs/CRITIC_ROUTE.md) 평가 결과. **1조 클래식 하이라이트를 원안·대체계획 모두 확정**.
...
### 대체계획 (Day 6 휴식 버전) — 1조 확정

Day 6 저녁 피로로 호텔 휴식 시, Day 7에 Vivid를 한 밤에 집중하는 대체 시나리오. **당일 체력에 따라 원안/대체 선택.**

| 순위 | 안 | 평균 | 설계(A') | 감성(B') | 실행(C') | 예산(2인) | 논쟁 |
|:----:|:---|:----:|:-------:|:-------:|:-------:|:---------:|:----:|
| 🥇 | 5조 로컬 숨은보석 | **80.0** | 80.0 | 80.8 | 79.3 | ₩47.7만 | |
| 🥈 | **1조 클래식 하이라이트** ✅ | **74.4** | 74.0 | 74.4 | 74.8 | ₩35.4만 | |
| 🥉 | 4조 Vivid 올인 | **70.3** | 69.0 | 72.8 | 69.0 | ₩40~49만 | |
| 4 | 2조 BridgeClimb 프리미엄 | **69.2** | 66.0 | 75.8 | 65.8 | ₩74.6만 | |
| 5 | 3조 호주정체성 탐험 | **67.4** | 65.0 | 79.6 | 57.5 | ₩62.4만 | 🔴 |

> 대체계획 점수 최고는 5조(80.0점, 만장일치)이나, 원안과의 일관성을 위해 **1조(74.4점)를 확정**. 상세: `research/sydney-plans/대체계획/README.md`
