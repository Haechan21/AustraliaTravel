...
> **현재 상태**: ✅ Phase 4 진행 중. **6조 확정** (바이런직행+블루마운틴, v7 1위 78.0점, 2026-03-20). 루트·숙소 7박 확정 (시드니 ValueSuites Green Square 포함), **Day 1~7 세부 일정 확정**. 시드니 Day 7은 **1조 클래식 하이라이트** 확정 (원안 77.7점, 대체계획 74.4점 — 당일 체력에 따라 선택, 2026-03-26). 식당 미확정.
...
│
├── research/                   # 리서치 자료 및 CRITIC 평가 근거
